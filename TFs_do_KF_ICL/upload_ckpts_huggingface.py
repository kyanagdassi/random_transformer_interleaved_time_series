...
repo_id = "sultan-daniels/ortho_haar_data"

#path to data
data_dir = "/data/shared/ICL_Kalman_Experiments/train_and_test_data/ortho_haar"

# # Path to checkpoints
# checkpoints_dir = "/data/shared/ICL_Kalman_Experiments/model_checkpoints/GPT2/250509_232740.d8a2db_multi_sys_trace_ortho_haar_state_dim_5_ident_C_lr_4.765825198443491e-06_num_train_sys_40000/checkpoints"
...
api.update_repo_settings(
    repo_id=repo_id,
    gated="manual",
    repo_type="dataset"  # <-- Add this line to specify the repo type
)
